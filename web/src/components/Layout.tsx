...
import {
  ...
  FileText, LogOut, Menu, X, Shield, ChevronRight, Sparkles
} from 'lucide-react';

const navItems = [
  { to: '/', icon: LayoutDashboard, label: 'Dashboard' },
  { to: '/schemes', icon: FileSearch, label: 'Schemes' },
  { to: '/recommend', icon: Sparkles, label: 'Get Matched' },
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="p-4 border-t border-surface-100">
            <div className="flex items-center gap-3 px-4 py-3">
              ...
              <button onClick={handleLogout} className="p-2 rounded-lg hover:bg-red-50 text-surface-400 hover:text-red-600 transition-colors" title="Logout">
