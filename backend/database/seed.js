...
const partners = [
    ['Tamil Nadu SC Finance Corporation', 'SCA', '123, Anna Salai, Chennai - 600001', '044-12345678', 'contact@tnscfc.in', 13.0827, 80.2707, 82.5, 6.2, 1, 'MFS,TL,SUI,SCST-H'],
    ['State Bank of India - Chennai Main', 'PSB', '456, Rajaji Salai, Chennai - 600001', '044-87654321', 'chennai.main@sbi.co.in', 13.0900, 80.2800, 85.0, 5.1, 1, 'MFS,TL,ELS,PMY-S,PMY-K,PMY-T'],
    ['Canara Bank - T Nagar', 'PSB', '789, North Usman Road, Chennai - 600017', '044-24345678', 'tnagar@canarabank.com', 13.0390, 80.2350, 78.0, 7.2, 0, 'MFS,TL,ELS,PMY-S,PMY-K'],
    ['Andhra Pradesh SC Finance Corp', 'SCA', '10 MG Road, Vijayawada - 520001', '0866-1234567', 'info@apscfc.in', 16.5062, 80.6480, 88.3, 4.5, 1, 'MFS,TL,SUI,SCST-H'],
    ['SBI - Bangalore Main', 'PSB', '21, MG Road, Bangalore - 560001', '080-87654321', 'bangalore.main@sbi.co.in', 12.9716, 77.5946, 91.2, 3.8, 1, 'MFS,TL,ELS,PMY-S,PMY-K,PMY-T'],
    ['Karnataka Grameena Vikas Bank', 'RRB', '5, Station Road, Hubli - 580020', '0836-2345678', 'info@kgvb.in', 15.3647, 75.1240, 82.0, 8.5, 1, 'MFS,TL,PMY-S,PMY-K'],
    ['HDFC Bank - Hyderabad', 'PSB', '100, Banjara Hills, Hyderabad - 500034', '040-67890123', 'hyderabad@hdfcbank.com', 17.3850, 78.4867, 95.0, 2.1, 1, 'MFS,TL,ELS,PMY-S,PMY-K,PMY-T'],
    ['Kerala SC Development Finance', 'SCA', '50, MG Road, Thiruvananthapuram - 695001', '0471-3456789', 'info@kscdf.in', 8.5241, 76.9366, 87.0, 5.3, 1, 'MFS,TL,SUI,SCST-H'],
    ['IDBI Bank - Cochin', 'PSB', '25, Market Road, Kochi - 682011', '0484-4567890', 'cochin@idbi.co.in', 9.9312, 76.2673, 89.5, 4.1, 1, 'MFS,TL,ELS,PMY-S,PMY-K,PMY-T'],
    ['Mizo Rural Bank', 'RRB', '12, Aizawl Bazaar, Aizawl - 796001', '0389-5678901', 'info@mizoruralbank.in', 23.7271, 92.7176, 75.0, 12.0, 0, 'MFS,TL,PMY-S,PMY-K'],
    ['Bihar SC Finance Corporation', 'SCA', '30, Gandhi Maidan, Patna - 800001', '0612-6789012', 'info@bscfc.in', 25.6093, 85.1376, 84.0, 6.8, 1, 'MFS,TL,SUI,SCST-H'],
    ['Punjab National Bank - Delhi', 'PSB', '7, Parliament Street, New Delhi - 110001', '011-78901234', 'delhi@pnbindia.in', 28.6139, 77.2090, 93.0, 3.5, 1, 'MFS,TL,ELS,PMY-S,PMY-K,PMY-T'],
    ['Gujarat SC Finance Board', 'SCA', '45, Ashram Road, Ahmedabad - 380009', '079-89012345', 'info@gsfc.in', 23.0225, 72.5714, 86.5, 5.0, 1, 'MFS,TL,SUI,SCST-H'],
    ['UCO Bank - Kolkata', 'PSB', '10, BTM Sarani, Kolkata - 700001', '033-90123456', 'kolkata@ucobank.co.in', 22.5726, 88.3639, 80.5, 7.0, 1, 'MFS,TL,ELS,PMY-S,PMY-K,PMY-T'],
    ['Assam Gramin Vikash Bank', 'RRB', '15, Fancy Bazaar, Guwahati - 781001', '0361-0123456', 'info@agvb.in', 26.1445, 91.7362, 79.0, 10.5, 0, 'MFS,TL,PMY-S,PMY-K'],
];
