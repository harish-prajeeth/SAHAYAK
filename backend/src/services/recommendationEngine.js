...
function ruleBasedRecommendation(input) {
    ...
    if (projectType === 'Education') {
        return { scheme: 'Educational Loan Scheme', code: 'ELS', matchScore: 95, rationale: 'This is an education loan. ELS offers up to ₹40 lakh at 6.5% interest with 12-year repayment.' };
    }
...
async function getRecommendation(userInput) {
    ...
    return {
        primary: {
            ...
            details: schemeResult.rows[0] || null,
